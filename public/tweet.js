riot.tag2('tweet', '<div><ul class="tweet_ul"><li class="tweet_li" each="{list}"><span style="float:left;">{number}</span><p style="text-align:center;">{tweet}</p></li></ul></div>', '.tweet_ul{ list-style-type: none; } .tweet_li{ display: block; border-bottom:solid; margin:5px; border-bottom-style: outset; } .tweet_li:hover{ background-color: #EEEEEE; }', '', function(opts) {
        this.list = [
